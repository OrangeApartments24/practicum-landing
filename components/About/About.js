    ...
    return(
        <section className={styles.about}>
            ...
            <article className={styles.item}>
                ...
                <p className={`text ${styles.itemText}`}>Если вы&nbsp;еще никогда не&nbsp;занимались бизнесом, но&nbsp;давно мечтали открыть свой бизнес&nbsp;&mdash; рекомендуем начать именно сейчас с&nbsp;краткосрочной аренды. Учитесь у&nbsp;тех, кто на&nbsp;практике доказывает, что может сам.</p>
            </article>

            <article className={styles.item}>
                <img src='/icons/business.svg' className={styles.itemIcon} />
                <h3 className={styles.itemHeading}>для бизнесменов</h3>
                <p className={`text ${styles.itemText}`}>Для бизнесменов, которые рассматривают краткосрочную аренду как вид бизнеса и&nbsp;интересуются пошаговым планом и&nbsp;&laquo;математикой&raquo;. При рентабельности 400%&nbsp;&mdash; 500% годовых окупаемость всего 3-4 месяца и&nbsp;нет сезонности.</p>
            </article>

            <article className={styles.item}>
                <img src='/icons/money.svg' className={styles.itemIcon} />
                <h3 className={styles.itemHeading}>для инвесторов</h3>
                <p className={`text ${styles.itemText}`}>Инвестиции в&nbsp;недвижимость с&nbsp;рентабельность от&nbsp;400% до&nbsp;500% годовых. Всегда инвестируйте в&nbsp;то, что понятно, прозрачно и&nbsp;безопасно.</p>
            </article>
